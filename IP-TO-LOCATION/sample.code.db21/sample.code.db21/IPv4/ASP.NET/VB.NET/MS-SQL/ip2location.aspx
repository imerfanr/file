...
<script runat="server">
    ...
    Sub Page_Load(Sender As Object, e As System.EventArgs)
        ...
        If Not String.IsNullOrEmpty(Request.Form("ipAddress")) Then
            ...
            If IPAddress.TryParse(ip, address) AndAlso address.AddressFamily = System.Net.Sockets.AddressFamily.InterNetwork Then ' IPv4
                Dim ipnum As BigInteger = IPNo(address)
                Dim ipnum2 As UInt32 = 0
                If UInt32.TryParse(ipnum.ToString(), ipnum2) Then
                    Using conn As SqlConnection = New SqlConnection(trusted) ' change to nontrusted if you're using username/password to connect to SQL Server
                        Dim query As String = "SELECT TOP 1 * FROM ip2location_db21 WHERE @ipnum <= ip_to"
                        Dim cmd As SqlCommand = New SqlCommand(query, conn)
                        cmd.Parameters.Add("@ipnum", Data.SqlDbType.BigInt)
