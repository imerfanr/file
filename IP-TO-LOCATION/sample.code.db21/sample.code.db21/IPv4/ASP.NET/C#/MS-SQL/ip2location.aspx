...
<script runat="server">
    ...
    public void Page_Load(object Sender, System.EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.Form["ipAddress"]))
        {
            ...
            if (IPAddress.TryParse(ip, out address) && address.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork) // IPv4
            {
                BigInteger ipnum = IPNo(ref address);
                UInt32 ipnum2 = 0;
                if (UInt32.TryParse(ipnum.ToString(), out ipnum2))
                {
                    ...
                    {
                        string query = "SELECT TOP 1 * FROM ip2location_db21 WHERE @ipnum <= ip_to";
                        SqlCommand cmd = new SqlCommand(query, conn);
                        cmd.Parameters.Add("@ipnum", System.Data.SqlDbType.BigInt);
