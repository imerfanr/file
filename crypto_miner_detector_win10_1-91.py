...
class AdvancedMinerDetector:
    ...
    def get_system_info(self):
        ...
        system_info = {
            'os': f"{platform.system()} {platform.platform()}",
    ...
    def monitor_processes(self):
        ...
        for proc in psutil.process_iter(['pid', 'name', 'cpu_percent', 'memory_info', 'cmdline', 'ppid']):
            try:
                proc_info = proc.info
    ...
    def comprehensive_network_scan(self, progress_callback=None):
        ...
        for ip in active_ips:
            ...
            if device_info['suspicion_score'] > 10:
                device_info['geolocation'] = self.geolocate_ip_sync(ip)
        
            if device_info['suspicion_score'] > 5:
